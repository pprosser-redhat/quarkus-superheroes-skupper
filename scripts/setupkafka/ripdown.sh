...
oc exec -it $POD -n superheroes -- bash -c 'export PGUSER=superman ; export PGPASSWORD=superman ; export PGDATABASE=heroes_database ; export PGHOST=heroes-db.superheroes.svc.cluster.local ; psql -c "delete from hero;"'